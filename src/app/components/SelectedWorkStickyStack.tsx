...
function StickyProjectCard({
  ...
  const topClass = ["top-20", "top-24", "top-28", "top-32"][index] ?? "top-20";

  return (
    <article
      className={`sticky ${topClass} mx-auto mb-[40vh] h-[68vh] w-full max-w-5xl overflow-hidden rounded-3xl border border-white/10 shadow-2xl`}
      style={{
        zIndex: index + 1,
      }}
    >
